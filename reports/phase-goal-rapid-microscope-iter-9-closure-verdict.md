...
# Phase goal-rapid-microscope-iter-9 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-9-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-9-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-9-audit.md`) | exists | PASS |
...
- what-to-click numbered steps: 11 (≥3 required)
