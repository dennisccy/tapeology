...
# Phase goal-rapid-microscope-iter-13 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-13-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-13-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-13-audit.md`) | exists | PASS |
