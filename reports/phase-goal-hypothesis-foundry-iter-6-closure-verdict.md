...
# Phase goal-hypothesis-foundry-iter-6 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-hypothesis-foundry-iter-6-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-hypothesis-foundry-iter-6-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-hypothesis-foundry-iter-6-audit.md`) | exists | PASS |
