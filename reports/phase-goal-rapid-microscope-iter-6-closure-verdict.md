...
# Phase goal-rapid-microscope-iter-6 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-6-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-6-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-6-audit.md`) | exists | PASS |
