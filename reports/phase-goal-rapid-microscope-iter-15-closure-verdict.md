...
# Phase goal-rapid-microscope-iter-15 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-15-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-15-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-15-audit.md`) | exists | PASS |
