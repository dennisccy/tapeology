...
# Phase goal-rapid-microscope-iter-7 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-7-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-7-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-7-audit.md`) | exists | PASS |
