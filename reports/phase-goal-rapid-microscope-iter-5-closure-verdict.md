...
# Phase goal-rapid-microscope-iter-5 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-5-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-5-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-5-audit.md`) | exists | PASS |
