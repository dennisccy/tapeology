...
# Phase goal-rapid-microscope-iter-17 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-17-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-17-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-17-audit.md`) | exists | PASS |
