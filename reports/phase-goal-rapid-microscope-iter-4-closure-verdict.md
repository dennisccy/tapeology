...
# Phase goal-rapid-microscope-iter-4 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-4-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-4-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-4-audit.md`) | exists | PASS |
