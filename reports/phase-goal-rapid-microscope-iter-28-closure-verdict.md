...
# Phase goal-rapid-microscope-iter-28 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-28-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-28-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-28-audit.md`) | exists | PASS |
