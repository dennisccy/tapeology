# Regression Replay — goal-desk-iter-34
...
|---------|------|------|----------|----------|--------|---------|----------|
| UT-J-19 | Every top-up run records the date each pair's frozen history actually reaches | regression | P1 | journey replays end-to-end; all expects hold | journey replayed end-to-end; all expects held | PASS | reports/qa/goal-desk-iter-34-evidence/J-19-verify.png |
...
- **Frontend URL:** http://127.0.0.1:3301
