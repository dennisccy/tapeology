...
# Phase goal-rapid-microscope-iter-21 — Closure Verdict
...
|----------|--------|---------|
| Review report (`reports/reviews/goal-rapid-microscope-iter-21-review.md`) | exists | PASS |
| QA report (`reports/qa/goal-rapid-microscope-iter-21-qa.md`) | exists | PASS |
| Audit report (`docs/handoffs/goal-rapid-microscope-iter-21-audit.md`) | exists | PASS |
