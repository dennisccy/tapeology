...
+from .micro_features import QUOTE_SIZE_UNITS
 ...
 SPLIT_TRAIN = "train"
@@ -87,6 +88,14 @@ VALID_SOURCE_KINDS = frozenset({SOURCE_REFERENCE, SOURCE_HISTORICAL})
 _ROW_TRADE = "trade"
 _ROW_QUOTE = "quote"
...
@@ -518,9 +626,15 @@ def record_from_source(
     end: str | None = None,
     config: Config,
