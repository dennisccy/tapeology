...
- `apps/backend/tests/test_micro_deterministic_rerun.py` (18 lines not shown)
...
diff --git a/apps/backend/tests/test_micro_deterministic_rerun.py b/apps/backend/tests/test_micro_deterministic_rerun.py
new file mode 100644
index 0000000..c00df20
--- /dev/null
+++ b/apps/backend/tests/test_micro_deterministic_rerun.py
@@ -0,0 +1,412 @@
...
... [diff_bound] apps/backend/tests/test_micro_deterministic_rerun.py: 18 more diff lines omitted — Read the file for full detail
```
