...
- `apps/frontend/app/desk/page.tsx` (685 lines not shown)
...
@@ -6072,6 +6096,715 @@ function MicroReadinessSection({
   );
 }
...
... [diff_bound] apps/frontend/app/desk/page.tsx: 685 more diff lines omitted — Read the file for full detail
