...
- **J-01: The era transition stands — the corpus truth on the record** — passing (stable; digested)
- **J-02: The micro observer — one pass, prefix-honest, benchmarked** — passing (stable; digested)
- **J-03: Structure x flow — the join that never looks ahead** — passing (stable; digested)
- **J-04: The Scout and the ledger — every trial on the record** — passing (stable; digested)
- **J-05: The walk-forward engine — chronology, fences, and the diagnostic run** — passing (stable; digested)
- **J-06: The recorder and the Vault — new tape, sealed at birth** — passing (stable; digested)
- **J-07: Graduation — provenance in, nothing laundered out** — passing (stable; digested)
- **J-08: The surface and MCP v6 — the funnel is visible** — passing (stable; digested)
- **J-09: The pilot studies — three predeclared questions, honest answers** — passing (stable; digested)
- **J-10: The kept product stands — traps armed, sentinel green** — passing (stable; digested)
<!-- AUTO:journeys -->
- **J-11: Graduation gets a surface — the funnel's last state stops being invisible** — passing (stable; digested)
