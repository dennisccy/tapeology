<!-- GOAL SLICE: generated by goal_gate.py. Stable passing journeys are
     digested to one line (20 of 21); vision, anti-goals, and
...
- **J-19: Every top-up run records the date each pair's frozen history actually reaches** — passing (stable; digested)
- **J-20: Every recorded screen states how it differs from the screen recorded before it** — passing (stable; digested)
