...
| J-13 Reference-close + band disclosure on ranked rows (price the wall sits at, beside the close it was measured from) — IN BUILD at iter-17 | `/desk` (ranked table column + row drill-in tooltip) | Desk |
