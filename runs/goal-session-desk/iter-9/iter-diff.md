...
diff --git a/apps/backend/scripts/goal-desk-iter9-scoped-backend.sh b/apps/backend/scripts/goal-desk-iter9-scoped-backend.sh
new file mode 100644
index 0000000..6d92d3c
--- /dev/null
+++ b/apps/backend/scripts/goal-desk-iter9-scoped-backend.sh
@@ -0,0 +1,74 @@
+#!/usr/bin/env bash
