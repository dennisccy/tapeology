...
Files changed: 70. Shown in full: 52.
...
@@ -66,6 +66,7 @@ Current capabilities (iter-17):
...
@@ -749,6 +828,93 @@ def run_lint(opts) -> int:
     return 0
...
@@ -1052,7 +1218,7 @@ def main(argv: list[str]) -> int:
     import argparse
...
@@ -1076,6 +1242,9 @@ def main(argv: list[str]) -> int:
     if opts.mode == "lint":
