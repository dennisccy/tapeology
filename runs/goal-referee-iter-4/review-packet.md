...
@@ -284,6 +322,64 @@ def test_permutation_test_enumeration_is_deterministic_with_zero_rng_draws():
     assert a == b
...
@@ -381,6 +477,93 @@ def test_permutation_test_no_informative_sessions_is_insufficient_sample():
...
@@ -549,3 +732,33 @@ def test_verify_oracle_attestation_rejects_a_non_dict_input():
