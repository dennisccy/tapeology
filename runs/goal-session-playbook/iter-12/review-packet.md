...
index af3158d..b7eec6e 100644
--- a/docs/goal.md
+++ b/docs/goal.md
@@ -701,6 +701,74 @@ J-03 section), then J-07 → J-08 → J-09, with J-10 guarding continuously.
...
## Excluded-path stat (dependency/lockfile visibility)
 ...
 runs/goal-session-playbook/state/assumptions.md | 20 +++++++++++
 runs/goal-session-playbook/state/blueprint.md   | 46 ++++++++++++++++++++-----
 runs/goal-session-playbook/telemetry.jsonl      | 19 ++++++++++
