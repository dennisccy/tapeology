...
index e92ef348..024790fc 100644
...
@@ -7962,6 +7964,161 @@ function HermeticOraclesSubsection({ data }: { data: FoundryHermeticOracles }) {
   );
 }
...
@@ -8096,6 +8253,25 @@ function HypothesisFoundrySection({
         )}
       </div>
