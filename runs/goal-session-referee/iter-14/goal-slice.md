...
- **J-01: The era transition stands — reconciliation made testable** — passing (stable; digested)
- **J-02: The evidence contract — two families, one observation shape** — passing (stable; digested)
- **J-03: The statistics core — calibrated, seeded, oracle-proven, fail-closed** — passing (stable; digested)
- **J-04: Matched nulls — comparable times, identical measurement** — passing (stable; digested)
- **J-05: The registry — pre-registration with an immutable boundary** — passing (stable; digested)
- **J-06: Estimand engines + adjudication — one checkpoint, recorded forever** — passing (stable; digested)
- **J-07: The starter family — historical exploration becomes registered questions** — passing (stable; digested)
- **J-08: The strategy family + the promotion interlock — fail closed, no bypass** — passing (stable; digested)
- **J-09: The Referee on /desk + MCP contract v5 — 22 read-only tools** — passing (stable; digested)
- **J-10: The kept product stands — regression sentinel** — passing (stable; digested)
<!-- AUTO:journeys -->
- **J-11: The accrual projection states its own basis — the wait, measured in recorded sessions** — passing (stable; digested)
- **J-12: The readiness fold gets its reader — why a family cannot speak, visible on the desk** — passing (stable; digested)
<!-- /AUTO:journeys -->
