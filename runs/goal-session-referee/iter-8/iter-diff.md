...
@@ -1132,6 +1150,18 @@ def run_evaluation_and_record(
...
+        )
     ...
     return {
         "families": families,
@@ -870,6 +931,222 @@ def registry_response(
     }
...
@@ -387,6 +388,128 @@ def test_tc9_below_target_reports_the_real_recount_never_the_registry_proxy(stor
...
@@ -587,6 +609,249 @@ def test_tc14_all_five_starter_candidates_register_cleanly_with_distinct_ids(sto
