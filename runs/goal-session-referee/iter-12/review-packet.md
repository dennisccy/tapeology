...
index cea64cf..dad6746 100644
--- a/docs/goal.md
+++ b/docs/goal.md
@@ -735,6 +735,74 @@ certificate checking).
...
## Excluded-path stat (dependency/lockfile visibility)
 ...
 runs/goal-session-referee/state/assumptions.md | 28 ++++++++++++++++++
 runs/goal-session-referee/state/blueprint.md   | 39 ++++++++++++++++++++++++++
