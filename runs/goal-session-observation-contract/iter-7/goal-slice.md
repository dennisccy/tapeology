<!-- GOAL SLICE: generated by goal_gate.py. Stable passing journeys are
     digested to one line (6 of 6); vision, anti-goals, and
...
- **J-01: The artifact is a pure projection with semantic identity, provenance and integrity** — passing (stable; digested)
- **J-02: Market-event time, measured availability and generation time are three distinct, honest instants, read atomically** — passing (stable; digested)
- **J-03: Lifecycle, feed basis and session identity stay honest** — passing (stable; digested)
- **J-04: Ingestion-path equivalence under an identical valid event stream** — passing (stable; digested)
- **J-05: One read-only machine path** — passing (stable; digested)
- **J-06: Guards and the regression sentinel** — passing (stable; digested)
## Anti-goals
