...
- **J-07: Goal Mode deterministically exhausts the frozen real epoch without changing science** — passing (stable; digested)
- **J-08: The operator sees the final Foundry truth and all foundation rails still hold** — passing (stable; digested)
## Anti-goals
