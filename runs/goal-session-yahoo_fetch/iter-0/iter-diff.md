...
Files changed: 65. Shown in full: 33.
...
- `diff --git aruns/goal-session-yahoo_fetch/trace/.lock bruns/goal-session-yahoo_fetch/trace/.lock` (3 diff lines)
...
- `incredible_auto_dev/scripts/automation/run-goal.sh` (7 lines not shown)
...
- `diff --git adocs/handoffs/goal-yahoo_fetch-iter-0-dev.md bdocs/handoffs/goal-yahoo_fetch-iter-0-dev.md` (274 lines not shown)
- `diff --git adocs/phases/goal-yahoo_fetch-iter-0.md bdocs/phases/goal-yahoo_fetch-iter-0.md` (121 lines not shown)
- `diff --git areports/goal-lint.md breports/goal-lint.md` (56 lines not shown)
- `diff --git areports/reviews/goal-yahoo_fetch-iter-0-review.md breports/reviews/goal-yahoo_fetch-iter-0-review.md` (32 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/.quota-pause-count bruns/goal-session-yahoo_fetch/.quota-pause-count` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/dispatch/.pump-alive bruns/goal-session-yahoo_fetch/dispatch/.pump-alive` (3 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/engine.pid bruns/goal-session-yahoo_fetch/engine.pid` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/.steps/decomposer.done bruns/goal-session-yahoo_fetch/iter-0/.steps/decomposer.done` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/.steps/developer.done bruns/goal-session-yahoo_fetch/iter-0/.steps/developer.done` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/.steps/review-1.done bruns/goal-session-yahoo_fetch/iter-0/.steps/review-1.done` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/goal-slice.md bruns/goal-session-yahoo_fetch/iter-0/goal-slice.md` (393 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/journey-history.pre.json bruns/goal-session-yahoo_fetch/iter-0/journey-history.pre.json` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/iter-0/snapshot-sha bruns/goal-session-yahoo_fetch/iter-0/snapshot-sha` (3 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/session.json bruns/goal-session-yahoo_fetch/session.json` (24 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/state/blueprint.md bruns/goal-session-yahoo_fetch/state/blueprint.md` (80 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/state/evaluator-log.md bruns/goal-session-yahoo_fetch/state/evaluator-log.md` (3 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/state/journey-history.json bruns/goal-session-yahoo_fetch/state/journey-history.json` (7 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/state/lessons.md bruns/goal-session-yahoo_fetch/state/lessons.md` (15 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/telemetry.jsonl bruns/goal-session-yahoo_fetch/telemetry.jsonl` (20 lines not shown)
- `diff --git aruns/goal-session-yahoo_fetch/trace/trace.jsonl bruns/goal-session-yahoo_fetch/trace/trace.jsonl` (9 lines not shown)
- `diff --git aruns/goal-yahoo_fetch-iter-0/status.json bruns/goal-yahoo_fetch-iter-0/status.json` (19 lines not shown)
...
@@ -207,11 +227,19 @@ ensure_cli_assets_synced "$CHAIN_CLI"
...
@@ -231,6 +259,11 @@ _run_iteration_summarizer() {
...
@@ -262,6 +295,12 @@ Recent evaluator log entries (last 300 lines, pre-trimmed):
 ${eval_log_inline}
 ---
...
@@ -707,6 +855,10 @@ if [[ -f "$SESSION_JSON" ]]; then
   RUN_MODE="resume"
 else
   validate_goal_file
...
@@ -780,7 +932,7 @@ if $( [[ "$AUTO_RELEASE" == "true" ]] && echo "True" || echo "False" ):
...
@@ -803,6 +955,14 @@ if [[ "$RUN_MODE" == "resume" && "$PRIOR_STATUS" == "AWAITING_BLUEPRINT_APPROVAL
...
@@ -1261,6 +1486,11 @@ Lessons learned (full file, append-only):
 \`\`\`
 $LESSONS_TAIL
 \`\`\`
...
+\`\`\`
 ...
 \`\`\`
 $JOURNEY_DIGEST
@@ -1463,6 +1693,8 @@ Do NOT write code or implement anything. The iteration spec and any blueprint ed
...
@@ -1473,12 +1705,24 @@ Do NOT write code or implement anything. The iteration spec and any blueprint ed
...
@@ -1514,6 +1758,7 @@ Iteration artifacts (read what exists):
...
+  Goal-edit drift note: $ITER_DIR/journeys-changed.md  <-- if present, each listed journey's prior pass is VOID until re-verified against the CURRENT goal text (your step 3)
 ...
 \`\`\`
@@ -1524,12 +1769,18 @@ Prior session state:
...
+Recent assumption entries (pre-trimmed):
... [diff_bound] incredible_auto_dev/scripts/automation/run-goal.sh: 7 more diff lines omitted — Read the file for full detail
diff --git a/incredible_auto_dev/skills/goal-authoring.md b/incredible_auto_dev/skills/goal-authoring.md
new file mode 100644
index 0000000..ef3d6cd
--- /dev/null
+++ b/incredible_auto_dev/skills/goal-authoring.md
@@ -0,0 +1,110 @@
+# Skill: goal-authoring — interviewing for, playing back, and checking `docs/goal.md`
+
+Used by `/goal-init` (interview → author) and, once it ships, by `/goal-lint` (checklist
