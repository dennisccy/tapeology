...
# Anti-goal ledger three-state classifier (resolved / blocking / owner-dispositioned).
_run_self_test scripts/automation/lib/anti_goal_disposition.py self-test
