...
TOOLS: tuple[types.Tool, ...] = (
    ...
    types.Tool(
        ...
        description=(
            ...
            "+1m/+5m/+1h/+4h trading-bars and to the session close -- SIGNED to each row's own "
            "side (support long, resistance negated: positive always means the wall worked; the "
            "convention is declared in the payload's `parameters.return_sign_convention` and is "
            "hashed into the record's input signature) -- and the unsigned long/short max "
